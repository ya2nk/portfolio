            ...
            <div class="modal-body">
                <form id="ajaxForm" name="ajaxForm" class="form-horizontal">
                    ...
                    <div class="form-group">
			            ...
			            <input type="number" name="percent" id="percent" min="0" max="100" class="form-control" >
			        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        setTimeout(function () {
                            ...
                            toast({
                                type: 'success',
                                title: ' Skill is successfully delete',
                                padding: '2em',
                            })
                        });
